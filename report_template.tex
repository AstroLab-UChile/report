...
To add a citation we use the \textit{bibtex} package, which is the standard way of citation in engineering, a citation example would be like this \cite{2022A&A...663A.106C}.
